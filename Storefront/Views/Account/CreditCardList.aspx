...
<script language="javascript" type="text/javascript">
    $(document).ready(function() {
        ...
        %>
        $("#DeleteCreditCard<%=count%>").click(function(e) {
            e.preventDefault();
           
            confirm("Are you sure you want to delete this Credit Card?", function() {
                window.location.href = "/Account/CreditCardDelete/<%=creditCard.CardID%>/<%=creditCard.Customer%>";
            });
        });
        <%}%>
...
<div class="frame">
    <fieldset>
    <legend>Edit or Delete a Credit Card</legend> 
    ...
    <div class="stripe">
        ...
        <a href="/Account/CreditCardMaint/<%=creditCard.CardID%>">Edit</a> <a href="#" id="DeleteCreditCard<%=count%>">Delete</a>
    </div>
    <br />
    <%}%>
    <div class="indexstripe">
        <div class="continue">
            <a href="#" id="Cancel">Cancel</a> <a href="/Account/CreditCardAdd/<%=customer.CustomerNo%>">Add a Credit Card</a>
        </div>
    </div>
    </fieldset>
</div>
